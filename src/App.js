...
class App extends Component {
  state = {
    ...
    value: '',
    message: ''
  }; //automatically placed inside constructor

  async componentDidMount() {
    const manager = await lottery.methods.manager().call(); //when we use metamask provider we do not specify from: account parameter
